...
const formSchema = z.object({
  ...
  type: z.nativeEnum(ChannelInteractionType)
});
 ...
 export const EditChannelModal = () => {
  ...
  const form = useForm({
    ...
    defaultValues: {
      name: "",
      type: channel?.channel_type || ChannelInteractionType.TEXT
    },
  });
  ...
  useEffect(()=>{
    if(channel){
      ...
      form.setValue("type", channel.channel_type);
    }
                ...
                render={({field}) => (
                  <FormItem>
                    ...
                    >
                      ...
                      <SelectContent>
                        {
                          Object.values(ChannelInteractionType).map((type)=> (
